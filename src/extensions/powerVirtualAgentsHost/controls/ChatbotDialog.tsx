...
export const ChatbotDialog: React.FunctionComponent<IChatbotDialogProps> = (props: IChatbotDialogProps) => {
  ...
  const theURL: string = `https://powerva.microsoft.com/api/botmanagement/v1/directline/directlinetoken?botId=4c9a6cd1-626f-46c9-967e-a21d6157083c&tenantId=72b17115-9915-42c0-9f1b-4f98e5a4bcd2`;
  ...
  return (
      <>
          <DefaultButton secondaryText={strings.ButtonAlternateText} onClick={toggleHideDialog} text={""} />
          <Dialog styles={{
